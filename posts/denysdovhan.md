...
Четвертое, в Atom есть родной apm (atom package manager) - это вам не сторонний прилепленный менеджер.
...
Кто еще такое практикует? Можете объяснить в чем плюсы? <a href="https://twitter.com/7rulnik" title="Valentin Semirulnik">@7rulnik</a>
...
RT <a href="https://twitter.com/_toydestroyer" title="Sergey Toy">@_toydestroyer</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> реквестирую сервис для кастомизации/создания иконочных шрифтов.
...
RT <a href="https://twitter.com/Bizi" title="Alexandr Bizikov">@Bizi</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> кстати, как ты отвлекаешься от работы? Может спорт? Хобби? Интересно было бы узнать у кого какие есть хобби :-)
...
Удобно, когда нужно много редактировать. У меня лептоп и 90% времени пользуюсь тачпадом и только для рисования макетов беру мышь <a href="https://twitter.com/yustovskiy" title="Nikita Yustovskiy">@yustovskiy</a>
...
... которой там быть не должно. Для логики есть js.
...
RT <a href="https://twitter.com/Bizi" title="Alexandr Bizikov">@Bizi</a>: Честно признаться, не использовал никогда системы сборки. Расскажите в кратце, чем они мне могут помочь? <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a>
...
RT <a href="https://twitter.com/from_anywhere" title="Иван Метелёв">@from_anywhere</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> самое важное изменение—возможность схлопнуть зависимости для юзеров на винде в более плоское дерево;впроче…
...
RT <a href="https://twitter.com/ravbetsky" title="Ravbetsky Artem">@ravbetsky</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> студент 6 курса, конструктор. Работаю в IT со 2 курса. Тогда и стало понятно, что ВУЗ для меня - бесполезная т…
...
RT <a href="https://twitter.com/Sigiller" title="S̳ị̴͙̣̞g̜͞i̴̥̯l͕ler">@Sigiller</a>: <a href="https://twitter.com/A11oW" title="Малышев Александр">@A11oW</a> <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> делфи приучает к аккуратному код-стайлу, кстати, потому что иначе просто нескомпилится)
...
По-моему, для первого курса куда лучше и проще будет учить python, или другой скриптовый язык. <a href="https://twitter.com/from_anywhere" title="Иван Метелёв">@from_anywhere</a>
...
RT <a href="https://twitter.com/akrekotun" title="Alexey Krekotun">@akrekotun</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> расскажи как долго привыкал к технике. Получается раздрабливать задачи на 25 минут и закрывать их за это время…
...
Для коммитов выборочных строк из файла использую git add --path или с алиасами git a -p <a href="https://twitter.com/rimmer333" title="Eugene Efimochkin σσ">@rimmer333</a>
...
<a href="https://t.co/8vcRnxizB4">github.com/devinhunt/type…</a> - а-ля normalize.css но для типографики (уже упоминалось здесь).
...
RT <a href="https://twitter.com/omtcyf0" title="Kirill Bobyrev">@omtcyf0</a>: <a href="https://twitter.com/adinvadim" title="Vadim">@adinvadim</a> <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> это по личным ощущениям от сравнения с Sublime. Хотя не стоит ожидать чего-то от редактора не на прав…
...
RT <a href="https://twitter.com/maxmaximov" title="Max Maximov">@maxmaximov</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> а для css, картинок и прочих шрифтов?
...
Ну так эту проблему и пытаюсь решать Webpack + babel-loader <a href="https://twitter.com/sapegin" title="Artem Sapegin">@sapegin</a> <a href="https://twitter.com/maxmaximov" title="Max Maximov">@maxmaximov</a>
...
RT <a href="https://twitter.com/Sigiller" title="S̳ị̴͙̣̞g̜͞i̴̥̯l͕ler">@Sigiller</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> как быть с чем? С пробелами в знаниях у людей? Заполнять их по возможности
...
Первое и самое важное что могу посоветовать - учите английский. Новой информации на русском очень мало, даже если кажется что ее много.
...
Чуть не забыл о шикарном <a href="http://t.co/lnjHOEUlxG">frontender.info</a> - заходите и читайте.
...
Расскажу о важной проблеме над которой мы думаем в <a href="https://twitter.com/codeguida" title="Codeguida">@codeguida</a> - словаре для разработчиков.
...
Я недавно статью читал о вредности работы с ноутбуком на коленях для мужчин. Так сказать, для "покемонончиков". <a href="https://twitter.com/life_maniac" title="Опасный сыч">@life_maniac</a>
...
RT <a href="https://twitter.com/freiksenet_ru" title="Михаил Новиков">@freiksenet_ru</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> Чуть ниже. Я пол дня сижу, пол дня стою (электронный стол это стандарт в Финл). Очень помогло со спиной, с…

RT <a href="https://twitter.com/kqxsr" title="kqxsr">@kqxsr</a>: <a href="https://twitter.com/meuwka" title="Nataliya Karatkova">@meuwka</a> <a href="https://twitter.com/iamstarkov" title="Vladimir Starkov">@iamstarkov</a> <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> кстати, вот такой проект еще есть <a href="http://t.co/4xdqNAWidK">kck.st/1Wt59xS</a>

Кстати лого похоже на лого <a href="https://twitter.com/official_iojs" title="io.js">@official_iojs</a>. <a href="https://twitter.com/kqxsr" title="kqxsr">@kqxsr</a> <a href="https://twitter.com/meuwka" title="Nataliya Karatkova">@meuwka</a> <a href="https://twitter.com/iamstarkov" title="Vladimir Starkov">@iamstarkov</a>

Давайте поговорим о [не]заменимости Macbook в работе верстальщика. Много у нас в сообществе людей без маков?

Я вот уже более двух лет спокойно работаю на Ubuntu. GNOME выглядит вполне красиво. <a href="http://t.co/U4lZoO1qmR">pic.twitter.com/U4lZoO1qmR</a>

Photoshop под Wine достаточно стабильный - у меня проблем не возникало.

Хотя собираюсь зимой ехать в Штаты и покупать макбук.

RT <a href="https://twitter.com/Kern_0" title="Арсений Максимов">@Kern_0</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> Плюсик в карму за Гном Три. Среди всех DE — это самая красивая.

А по теме, неделю назад пересел на макбук — очен…

RT <a href="https://twitter.com/Bizi" title="Alexandr Bizikov">@Bizi</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> хоть и на маке, но считаю что для верстальщика он не обязателен. Сижу на IDEA, которая работает на всех платформах

Расскажу о минусах работы на Ubuntu.

1. Полная жуть при установке драйверов к видеокарте. Особенно если у вас АТІ.

2. Хотя Photoshop и работает под Wine без лагов, но на больших файлах чувствуется тормоза. Illustrator вообще не работает.

3. У меня, после гибернации, иногда отваливается драйвер Wi-Fi.

Больше проблем не замечал. С какими сталкивались вы?

RT <a href="https://twitter.com/gearmobile" title="Valery Semenencko">@gearmobile</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a>  Добавляем к Linux такие инструменты, как AdobeExtact или Avocode - и вообще все прекрасно! Лучше MacOSX. И в…

RT <a href="https://twitter.com/hellbeast92" title="Александр Староверов">@hellbeast92</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> убунта + гном, idea, полёт нормальный, никакой надобности в маке не испытываю. Но я не рисую.

А вот я рисую часто, поэтому часто возможностей вайновского фотошопа нехватает. <a href="https://twitter.com/hellbeast92" title="Александр Староверов">@hellbeast92</a>

RT <a href="https://twitter.com/sapegin" title="Artem Sapegin">@sapegin</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> Про мак расскажу: рабочий иногда не находит трекпад после долгой спячки. Спасает только перезагрузка.

Народ, а подскажите пожалуйста аналитику для статического сайта, с возможностью отправлять отчеты на почту. Кроме гугла.

RT <a href="https://twitter.com/andrey_sitnik" title="Андрей Ситник">@andrey_sitnik</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> у меня Fedora с GNOME Shell на Yoga 3 Pro. Больше по идеологическим соображениям, но браузер везде одинако…

## Воскресенье <small>45 твитов</small>

Сегодня воскресенье, а значит время отдохнуть! Всем привет из Хотинской крепости! <a href="http://t.co/Qhj9oAifiC">pic.twitter.com/Qhj9oAifiC</a>

Сегодня решили прокатиться по крепостях в Хотин и Камянец-Подольский. А как отдыхаете от работы вы? Где ищете вдохновение?

RT <a href="https://twitter.com/sapegin" title="Artem Sapegin">@sapegin</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> Сегодня иду на выставку Себастьяна Сальгадо (фотограф такой :–)

RT <a href="https://twitter.com/life_maniac" title="Опасный сыч">@life_maniac</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> стараюсь уехать подальше от Москвы, на природу. Иногда даже один, чтобы с мыслями собраться.

RT <a href="https://twitter.com/gearmobile" title="Valery Semenencko">@gearmobile</a>: <a href="https://twitter.com/midler" title="midler">@midler</a> <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> <a href="http://t.co/rziJFzIGm8">zencoder.ru/css/adobe-extr…</a>, <a href="http://t.co/EqB4Woj4ly">zencoder.ru/css/project-pa…</a>. Вообще - очень доволен AbodeExtract. Пользуюсь им чащ…

Чуть не забыл, я вчера закончил редизайн своего блога: <a href="http://t.co/bNRxKNOOP9">denysdovhan.com/hello-world/</a>

Хотя по-факту это было восстановление с нуля.

Пока я жду автобуса домой, расскажу о том, что я называю "спортивными собеседованиями".

Идея вообщем в том, чтобы ходить на собеседование без цели устройства на роботу, а чтобы потренироваться и решить интересные задания.

Если вы прошли собеседование - говорите, что вы не заинтересованы в работе, если да, то ничего страшного - вы и не собирались.

К собеседованиям готовлюсь с помощью этого: <a href="https://t.co/EZKPI66t8i">github.com/h5bp/Front-end…</a>

RT <a href="https://twitter.com/VasyaRomashova" title="Vasya R">@VasyaRomashova</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> как при таком подходе не прослыть чудиком и не заработать себе негативную репутацию?

Просто готовиться и не делать этого если чувствуешь себя не готовым. <a href="https://twitter.com/VasyaRomashova" title="Vasya R">@VasyaRomashova</a>

RT <a href="https://twitter.com/webholt" title="Vlad :: gwer">@webholt</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> Идея отличная, но смущает тот факт, что однажды может понадобиться реально пойти туда работать. И как-то неудобн…

Возможно, но у меня наоборот - говорят чтобы обращался когда понадобится работа и им такие кадры нужны. <a href="https://twitter.com/webholt" title="Vlad :: gwer">@webholt</a>

RT <a href="https://twitter.com/redcat_nsk" title="Red Cat">@redcat_nsk</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> на собеседования ходить нужно раз в полгода, чтобы не оторваться от потребностей рынка. <a href="https://twitter.com/VasyaRomashova" title="Vasya R">@VasyaRomashova</a>

RT <a href="https://twitter.com/unel86" title="Peter Jah (0-)">@unel86</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> не проще просто просматривать периодически вакансии?)

Нет, суть в том, чтобы научиться чувствовать себя уверенно и спокойно на собеседованиях. <a href="https://twitter.com/unel86" title="Peter Jah (0-)">@unel86</a>

RT <a href="https://twitter.com/meuwka" title="Nataliya Karatkova">@meuwka</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> лично для меня собеседование - это стресс, даже если я не хочу там работать, всё равно буду стрессовать )

Главная идея этой затеи в том и состоит, чтобы научиться преодолевать стресс. <a href="https://twitter.com/meuwka" title="Nataliya Karatkova">@meuwka</a>

RT <a href="https://twitter.com/sapegin" title="Artem Sapegin">@sapegin</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> Я примерно то же самое советую: <a href="http://t.co/4X2UxyPOQp">nano.sapegin.ru/all/coding-int…</a>

RT <a href="https://twitter.com/sapegin" title="Artem Sapegin">@sapegin</a>: <a href="https://twitter.com/meuwka" title="Nataliya Karatkova">@meuwka</a> Собеседования — отличный способ узнать о пробелах в опыте и знаниях. <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a>

RT <a href="https://twitter.com/sapegin" title="Artem Sapegin">@sapegin</a>: <a href="https://twitter.com/meuwka" title="Nataliya Karatkova">@meuwka</a> После десятка собеседований в течение нескольких месяцев мне стало гораздо легче :-) <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a>

RT <a href="https://twitter.com/dmitry_dok" title="dmitry">@dmitry_dok</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> а ещё, как не начать чувствовать себя никчемным после нескольких отказов?

После отказа учить усердней, чтобы отказов не было. И если постоянно отказывают, то лучше заняться чем-то другим. <a href="https://twitter.com/dmitry_dok" title="dmitry">@dmitry_dok</a>

RT <a href="https://twitter.com/exdeniz" title="exdeniz">@exdeniz</a>: Про пики. Порекомендую сервис закладок - <a href="http://t.co/Iho0VgfQyl">raindrop.io</a> и там же мою коллекцию про SVG - <a href="https://t.co/Svm05KLJAV">raindrop.io/collection/246…</a> <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a>

В догонку о своем новом блоге: загляните также в сурсы, там интересно <a href="https://t.co/sgoC2gX3iw">github.com/denysdovhan/de…</a>

И так, моя неделя подходит к концу. У меня остался Еще один час (по Киеву). Давайте коротко вспомним что было на этой неделе.

В понедельник мы говорили об рабочем окружении: Atom, Sublime, dotfiles, темы для редактора и терминала.

Во вторник говорили о препроцессорах, системах сборки и около того.

Среда ознаменовала дискуссии об образовании и его проблемах.

В четверг говорили об Open Source: Bower, npm, Polymer и словаре для разработчиков.

В пятницу говорили о там как быть в тренде, кого фоловить, что читать и где находить свежую информацию.

В субботу было о ваших пэт-проектах, системе для верстки, работе стоя.

Ну и наконец, сегодня, в воскресенье, мы говорили о вдохновении, отдыхе от работы и собеседованиях.

RT <a href="https://twitter.com/lifeasecond" title="Arthur Ikeagold">@lifeasecond</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> бесплатные ресурсы типа <a href="http://t.co/97yNUa387N">learn.javascript.ru</a> и купил kindle для этого.

RT <a href="https://twitter.com/dmitruksergey" title="Serhii Dmytruk">@dmitruksergey</a>: <a href="https://twitter.com/cssunderhood" title="Верстальщик">@cssunderhood</a> книжки, англійська, нові технології, подорожі. Ну і фізичний розвиток.

Очень не хочется с вами прощаться! Вы все чертовски крутые! Общаться с вами было невероятно занимательно и приятно!

Надеюсь наше общение продолжиться в моем оригинальном профиле <a href="https://twitter.com/denysdovhan" title="Denys Dovhan">@denysdovhan</a> - я всегда рад помочь или просто поговорить))

Также заходите на мой github-профиль <a href="https://t.co/Eb50DHEb4y">github.com/denysdovhan</a> и читайте мой новый блог <a href="http://t.co/pBfhhUieGr">denysdovhan.com</a>.

Пишу я, как правило, на английском. Иногда на родном украинском. Отвечать могу и на русском.

И пожалуйста, ответы с последних твитов с упоминанием моего профиля, чтобы я их не пропустил.
